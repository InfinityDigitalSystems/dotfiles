def keymaps(config):
    ...
    # Darkmode
    config.bind('d', 'config-cycle content.user_stylesheets ./stylesheets/apprentice-all-sites.css "./stylesheets/darkmode_fixes.css"')
    ...
    config.bind('xV', "spawn mpv {url}") # Open rapid hint to open video in custom mpv script
